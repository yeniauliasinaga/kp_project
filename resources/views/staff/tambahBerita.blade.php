...
<div class="max-w-4xl mx-auto bg-yellow-100 p-8 rounded-xl shadow-lg mt-6">
    ...
    <form method="POST" action="{{ isset($berita) ? route('staff.berita.update', $berita->id) : route('staff.berita.store') }}" enctype="multipart/form-data">
        @csrf
        @if(isset($berita))
            @method('POST')
        @endif
        ...
        <div class="space-y-4">
            ...
            <div class="flex justify-end space-x-4 pt-4">
                <a href="{{ route('staff.berita') }}" class="bg-gray-400 text-white px-6 py-2 rounded hover:bg-gray-500">Kembali</a>
